...
package {
	...
	public class Bridge{
		...
		public static function createBridge(m_world:b2World,m_physScale:Number){
			...
			// Bridge
			{
				...
				sd.SetAsBox(24 / m_physScale, 100 / m_physScale);
				fixtureDef.shape = sd;
				...
				{
					bd.position.Set((100 + 22 + 44 * i) / m_physScale, 20 / m_physScale);
