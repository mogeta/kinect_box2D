...
package General{
	...
	public class Input{
		...
		public function Input(stage:Stage){
			...
			// add key listeners
			m_stageMc.addEventListener(KeyboardEvent.KEY_DOWN, keyPress, false, 0, true);
			m_stageMc.addEventListener(KeyboardEvent.KEY_UP, keyRelease, false, 0, true);		
			
			// mouse listeners
			m_stageMc.addEventListener(MouseEvent.MOUSE_DOWN, mousePress, false, 0, true);
			m_stageMc.addEventListener(MouseEvent.CLICK, mouseRelease, false, 0, true);
			m_stageMc.addEventListener(MouseEvent.MOUSE_MOVE, mouseMove, false, 0, true);
			m_stageMc.addEventListener(Event.MOUSE_LEAVE, mouseLeave, false, 0, true);
		...
		// stage
		static public var m_stageMc:Stage;
	}
